...
const ContactSection = dynamic(() => Promise.resolve(ContactSectionComponent), { ssr: false });
    ...
    <div className="dark min-h-screen transition-colors duration-300">
      <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-blue-900 text-white">
        <Head>
          ...
          <meta
            name="description"
            content="Omkar - Java Backend Developer passionate about Cybersecurity, Cloud, and DevOps"
          />
        </Head>
        ...
        <main className="scroll-smooth">
          <section id="home" className="py-24 px-6 text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              A backend developer passionate about <strong>Cybersecurity</strong>, <strong>Cloud</strong>, and <strong>DevOps</strong>.  
I build scalable systems with a focus on secure and efficient development.
            </p>

            <div className="flex gap-6 text-2xl mt-6 justify-center">
              <a
                href="https://github.com/itz-omkar-shinde-1432"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/omkar-shinde-3907a927a"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-cyan-400"
              >
              ...
              <a
                href="https://hashnode.com/@securewithomkar"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-cyan-400"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <a
                href="#contact"
                className="inline-block bg-cyan-500 hover:bg-cyan-400 text-black font-semibold py-3 px-8 rounded-full transition"
              >
                Get in Touch
              </a>
              <button
                className="bg-cyan-600 hover:bg-cyan-500 text-white font-semibold px-8 py-3 rounded-full cursor-not-allowed opacity-80"
              >
                Resume (Coming Soon)
              </button>
            </div>
          ...
          <section id="about" className="py-24 px-6 text-center" data-aos="fade-up">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                I'm a B.Tech student specializing in Cyber Security, driven by a deep passion for ethical hacking and problem-solving. I enjoy exploring new technologies and consistently diving deeper into the dynamic world of cybersecurity. <br/>
    ...
    <section id="contact" className="py-24 px-6 text-center" data-aos="fade-up">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <div className="g-recaptcha" data-sitekey="6LcXw24rAAAAAHuV5Gzo-PIncbdiEQ5pup-h62fL"></div>
